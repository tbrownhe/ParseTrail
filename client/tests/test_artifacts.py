...
def test_resolves_plain_plugin_name(tmp_path: Path) -> None:
    assert resolve_artifact_destination(
        tmp_path, "pdf_example_202601.pyc", allowed_suffixes={".pyc"}
